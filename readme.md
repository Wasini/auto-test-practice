...
* Para el rango de enteros considerar:
	...
	* Menores a 0
	* 0
* Para la cantidad de listas generadas podemos tener en cuenta la cantidad de combinaciones entre el rango de enteros 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNzgyMzU3NSwxMzc1MTcyNjMyLDE5OD
